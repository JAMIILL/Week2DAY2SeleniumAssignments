...
public static void main(String[] args) {
	...
	driver.manage().window().maximize();
	 ...
	 driver.findElement(By.id("updateLeadForm_annualRevenue")).clear();
	 driver.findElement(By.id("updateLeadForm_numberEmployees")).clear();
	 
	 driver.findElement(By.id("updateLeadForm_annualRevenue")).sendKeys("200000");
	 driver.findElement(By.id("updateLeadForm_numberEmployees")).sendKeys("2000");
